...
<body class="flex items-center justify-center p-4">
    <div class="register-container bg-white rounded-xl shadow-xl w-full max-w-md p-8 md:p-10 my-8">
        ...
        <form id="registerForm" action="../app/controllers/RegisterController.php" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <div class="mt-2 bg-gray-200 rounded-full overflow-hidden">
                    <div id="passwordStrength" class="password-strength bg-red-500 rounded-full" style="width: 0%">
                    </div>
                </div>
                <p id="passwordHint" class="mt-1 text-xs text-gray-500">Password should be at least 8 characters with
            ...
            <div class="flex items-start">
                ...
                <div class="ml-3 text-sm">
                    <label for="terms" class="text-gray-700">I agree to the <a href="#"
                            ...
                            class="text-indigo-600 hover:text-indigo-500">Privacy Policy</a></label>
                </div>
            </div>
        ...
        <div id="notification"
            class="fixed top-4 right-4 bg-green-100 border-l-4 border-green-500 text-green-700 p-4 rounded shadow-md hidden">
            <div class="flex">
